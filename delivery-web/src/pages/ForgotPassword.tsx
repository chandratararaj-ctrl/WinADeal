                ...
                <div className="bg-white rounded-lg shadow-xl p-8">
                    {step === 'REQUEST' && (
                        <form onSubmit={handleRequestOTP} className="space-y-6">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-sky-600 text-white py-3 rounded-lg font-semibold hover:bg-sky-700 transition-colors disabled:bg-gray-400 flex items-center justify-center gap-2"
                            >
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 outline-none font-mono text-lg tracking-widest"
                                        required
                                    />
                                </div>
                            </div>
                    ...
                    {step === 'SUCCESS' && (
                        <div className="text-center py-6">
                            ...
                            <Link
                                to="/login"
                                className="inline-block w-full bg-sky-600 text-white py-3 rounded-lg font-semibold hover:bg-sky-700 transition-colors"
                            >
                                Back to Login
                            </Link>
                        </div>
